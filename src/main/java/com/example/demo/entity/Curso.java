...
public class Curso {
    ...
    @ManyToMany(mappedBy = "cursos") //Mapped apenas em um dos lados da relação
    private List<Aluno> alunosList;


    public Curso(Long id, String nome, int cargaHoraria, int qtdSemestres, String descricao, Centro centro) {
        this.id = id;
        this.nome = nome;
